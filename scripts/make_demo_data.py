...
SPEC = {
    ...
    "hy_yield":      daily(12, 6.4, 0, 0.05, floor=3.5, cap=15, mean_rev=7.2),
...
META = {
    ...
    "hy_yield":      dict(name="미국 하이일드 금리", unit="%", decimals=2, threshold=None, below_is=None, freq="daily", source="FRED"),
